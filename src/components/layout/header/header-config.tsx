...
const AdvancedAnalysisIcon = () => (
    <svg width='20' height='20' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <rect x='3' y='3' width='18' height='18' rx='2' stroke='currentColor' strokeWidth='2' fill='none' />
        <path d='M3 9h18M9 3v18' stroke='currentColor' strokeWidth='2' />
        <circle cx='15' cy='15' r='2' fill='#00D4FF' />
        <path d='M12 12l3 3' stroke='#00FF88' strokeWidth='2' strokeLinecap='round' />
        <path d='M15 12l3 3' stroke='#FFD93D' strokeWidth='2' strokeLinecap='round' />
        <circle cx='6' cy='6' r='1' fill='#FF6B6B' />
        <circle cx='15' cy='6' r='1' fill='#A78BFA' />
        <circle cx='6' cy='15' r='1' fill='#34D399' />
    </svg>
);
...
export const MenuItems: MenuItemsConfig[] = [
    ...
    },
    {
        ...
        icon: <AdvancedAnalysisIcon />,
        label: localize('Advanced Analysis'),
    },
    {
        as: 'a',
